...
export default {
  ...
  created() {
    ...
    this.getCompanyInfo() // 根据id查询企业
  },
  methods: {
    async getRoleList() {
      const { total, rows } = await getRoleList(this.page) // 获取所有角色列表
    ...
    async getCompanyInfo() {
      this.formData = await getCompanyInfo(this.companyId) // 根据id查询企业
    },
    ...
    // 编辑
    async editRole(id) {
      this.roleForm = await getRoleDetail(id) // 根据id获取角色详情
