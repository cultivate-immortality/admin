...
const cos = new COS({
  SecretId: 'AKIDymLdeOt86nBLEqCH5cw0nJXVCcldFbgU', // 身份识别ID
  SecretKey: 'atue8MJzOXP0LQEm34nFQKxJOCj00jRt' // 身份密钥
})
export default {
  data() {
    return {
      showPercent: false, // 默认隐藏百分比
      percent: 0, // 当前的百分比
  ...
  methods: {
    ...
    upload(params) {
      if (params.file) {
        // 执行上传操作
        cos.putObject({
          Bucket: 'cultivate-immortality-1312518793', // 存储桶
